<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="../../../public/favicon.png" alt=""> <span>Quản trị TNTT</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/students">
						...
						<span class="label">Quản lý đoàn sinh</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/class">
						...
						<span class="label">Quản lý lớp học</span>
					</router-link>
				</a-menu-item>
